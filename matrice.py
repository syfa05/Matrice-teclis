...
for file_name in os.listdir(folder_path):
    if file_name.endswith('.xlsx'):
        ...
        # Calculer la valeur crête à crête pour la colonne 'Volume' entre les lignes 174 et 207
        volume_values = pd.to_numeric(df.iloc[173:207][5], errors='coerce')  # Convertir en valeurs numériques
